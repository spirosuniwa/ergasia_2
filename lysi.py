...
COLOR_FROM_ENV = os.environ.get('APP_COLORHEXCODE')# το APP_COLOR ειναι environment variable --το αντιστοιχο στα linux ειναι το export 
                                                   #το αντιστοιχο στα windows ειναι το set--η python με το os.environ.get διαβάζει απο το os τα αντιστοιχα variables
                                                   #https://stackoverflow.com/questions/4906977/how-can-i-access-environment-variables-in-python
                                                   #επομένως θα κανουμε την αλλαγη στο environment variable αλλα και στο argument στην γραμμη 60
...
if __name__ == "__main__":
    ...
    if args.colorhexcode:     #η αλλαγη στο -- args.colorhexcode όπως περιγράφηκε στην γραμμη 21 - 24
        print("Color from command line argument =" + args.colorhexcode)
        COLOR = args.colorhexcode #grapse ena sxolio
        if COLOR_FROM_ENV:
